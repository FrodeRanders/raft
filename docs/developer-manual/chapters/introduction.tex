...
\item Section~\ref{sec:ConsistencyBoundaries} covers the split-brain, partition, and consistency guarantees an application can rely on.
\item Section~\ref{sec:RaftAndXatmi} maps Raft concepts to XATMI/XA transaction thinking for developers coming from that background.
