...
public final class ClusterSummaryRequest {
    ...
    /**
     * Creates an unauthenticated cluster summary request.
     *
    ...
    /**
     * Creates a cluster summary request.
     *
     * @param term sender term
     * @param peerId requesting peer identifier
     ...
     */
    public ClusterSummaryRequest(long term, String peerId, String authScheme, String authToken) {
        this.term = term;
        this.peerId = peerId;
