...
class RaftNodeElectionTest {
    ...
    static class QueuedRaftClient extends RaftClient {
        ...
        @Override
        public java.util.concurrent.CompletableFuture<List<VoteResponse>> requestVoteFromAll(Collection<Peer> peers, VoteRequest voteReq) {
    ...
    void staleHeartbeatDoesNotRefreshTimeout() {
        ...
        RaftNode n = newTestNode(me, List.of(b), 1_000, new QueuedRaftClient("A", Map.of()), new InMemoryLogStore(), time, new Random(123));
    ...
    void staleLogCandidateCannotWin() {
        ...
        RaftNode nodeB = newTestNode(b, List.of(a), 100, new QueuedRaftClient("B", Map.of()), storeB, time, new Random(1));
    ...
    void voteGrantedOncePerTermUnlessSameCandidate() {
        ...
        RaftNode nodeB = newTestNode(b, List.of(a, c), 100, new QueuedRaftClient("B", Map.of()), new InMemoryLogStore(), time, new Random(1));
    ...
    void staleVoteResponsesAreIgnored() {
        ...
        RaftNode nodeA = newTestNode(a, List.of(b), 100, new QueuedRaftClient("A", Map.of()), new InMemoryLogStore(), time, new Random(1));
    ...
    void majorityRequiredToBecomeLeader() {
        ...
        RaftNode nodeA = newTestNode(a, List.of(b, c, d, e), 100, new QueuedRaftClient("A", Map.of()), new InMemoryLogStore(), time, new Random(1));
    ...
    void leaderElectionAppendsAndCommitsNoopEntry() {
        ...
        RaftNode nodeA = newTestNode(a, List.of(b, c), 100, clientA, storeA, time, new Random(1));
        RaftNode nodeB = newTestNode(b, List.of(a, c), 100, clientB, storeB, time, new Random(2));
        RaftNode nodeC = newTestNode(c, List.of(a, b), 100, clientC, storeC, time, new Random(3));
    ...
    void candidateStepsDownOnSameTermHeartbeat() {
        ...
        RaftNode nodeA = newTestNode(a, List.of(b), 100, clientA, new InMemoryLogStore(), time, new Random(1));
        RaftNode nodeB = newTestNode(b, List.of(a), 100, clientB, new InMemoryLogStore(), time, new Random(2));
    ...
    void electionTimeoutJitterIsSampledOncePerTimeoutWindow() {
        ...
        Peer a = peer("A");
        Peer b = peer("B");
        RaftNode nodeA = newTestNode(a, List.of(b), 100, new QueuedRaftClient("A", Map.of()), new InMemoryLogStore(), time, rng);
    ...
    void threeNodeElectionEventuallyElectsSingleLeader() {
        ...
        RaftNode nodeA = newTestNode(a, List.of(b, c), 200, clientA, new InMemoryLogStore(), time, new Random(1));
        RaftNode nodeB = newTestNode(b, List.of(a, c), 200, clientB, new InMemoryLogStore(), time, new Random(2));
        RaftNode nodeC = newTestNode(c, List.of(a, b), 200, clientC, new InMemoryLogStore(), time, new Random(3));
