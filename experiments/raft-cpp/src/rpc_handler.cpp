...
std::optional<raft::ClusterSummaryResponse> StubRpcHandler::on_cluster_summary_request(const raft::ClusterSummaryRequest&) {
...
std::optional<raft::ClientCommandResponse> StubRpcHandler::on_client_command_request(const raft::ClientCommandRequest& request) {
...
std::optional<raft::ClientQueryResponse> StubRpcHandler::on_client_query_request(const raft::ClientQueryRequest& request) {
...
std::optional<raft::JoinClusterResponse> StubRpcHandler::on_join_cluster_request(const raft::JoinClusterRequest& request) {
...
std::optional<raft::JoinClusterStatusResponse> StubRpcHandler::on_join_cluster_status_request(const raft::JoinClusterStatusRequest& request) {
...
std::optional<raft::ReconfigureClusterResponse> StubRpcHandler::on_reconfigure_cluster_request(const raft::ReconfigureClusterRequest& request) {
...
std::optional<raft::AppendEntriesResponse> StubRpcHandler::on_append_entries_request(const raft::AppendEntriesRequest&) {
...
std::optional<raft::InstallSnapshotResponse> StubRpcHandler::on_install_snapshot_request(const raft::InstallSnapshotRequest& request) {
...
InMemoryRpcHandler::InMemoryRpcHandler(std::string peer_id, std::int64_t current_term, std::int64_t last_log_index, std::int64_t last_log_term)
...
void InMemoryRpcHandler::set_known_peer_endpoints(const std::vector<Endpoint>& endpoints_by_position, const std::vector<std::string>& peer_ids) {
...
std::optional<raft::TelemetryResponse> InMemoryRpcHandler::on_telemetry_request(const raft::TelemetryRequest& request) {
...
std::optional<raft::ClusterSummaryResponse> InMemoryRpcHandler::on_cluster_summary_request(const raft::ClusterSummaryRequest&) {
    const auto now = std::chrono::duration_cast<std::chrono::milliseconds>(
                         std::chrono::system_clock::now().time_since_epoch())
                         .count();
    raft::ClusterSummaryResponse response;
...
std::optional<raft::ClientCommandResponse> InMemoryRpcHandler::on_client_command_request(const raft::ClientCommandRequest& request) {
    raft::ClientCommandResponse response;
    response.set_term(node_->current_term());
    response.set_peer_id(node_->peer_id());
...
std::optional<raft::ClientQueryResponse> InMemoryRpcHandler::on_client_query_request(const raft::ClientQueryRequest& request) {
    raft::ClientQueryResponse response;
    response.set_term(node_->current_term());
    response.set_peer_id(node_->peer_id());
    populate_leader_endpoint(response);
...
std::optional<raft::JoinClusterResponse> InMemoryRpcHandler::on_join_cluster_request(const raft::JoinClusterRequest& request) {
    raft::JoinClusterResponse response;
    response.set_term(node_->current_term());
    response.set_peer_id(node_->peer_id());
    response.set_leader_id(node_->leader_id().value_or(""));
...
std::optional<raft::JoinClusterStatusResponse> InMemoryRpcHandler::on_join_cluster_status_request(const raft::JoinClusterStatusRequest& request) {
    raft::JoinClusterStatusResponse response;
    response.set_term(node_->current_term());
    response.set_peer_id(node_->peer_id());
    response.set_leader_id(node_->leader_id().value_or(""));
...
std::optional<raft::ReconfigureClusterResponse> InMemoryRpcHandler::on_reconfigure_cluster_request(const raft::ReconfigureClusterRequest& request) {
    raft::ReconfigureClusterResponse response;
    response.set_term(node_->current_term());
    response.set_peer_id(node_->peer_id());
    response.set_leader_id(node_->leader_id().value_or(""));
...
std::optional<raft::AppendEntriesResponse> InMemoryRpcHandler::on_append_entries_request(const raft::AppendEntriesRequest& request) {
    return node_->handle_append_entries(request);
}

std::optional<raft::InstallSnapshotResponse> InMemoryRpcHandler::on_install_snapshot_request(const raft::InstallSnapshotRequest& request) {
...
void InMemoryRpcHandler::populate_member(raft::ClusterMemberSummary& member, const std::string& peer_id, bool local, std::int64_t next_index, std::int64_t match_index) const {
...
std::optional<raft::TelemetryResponse> PersistentRpcHandler::on_telemetry_request(const raft::TelemetryRequest& request) {
    return delegate_.on_telemetry_request(request);
}

std::optional<raft::ClusterSummaryResponse> PersistentRpcHandler::on_cluster_summary_request(const raft::ClusterSummaryRequest& request) {
    return delegate_.on_cluster_summary_request(request);
}

std::optional<raft::ClientCommandResponse> PersistentRpcHandler::on_client_command_request(const raft::ClientCommandRequest& request) {
    auto response = delegate_.on_client_command_request(request);
    persist();
    return response;
}

std::optional<raft::ClientQueryResponse> PersistentRpcHandler::on_client_query_request(const raft::ClientQueryRequest& request) {
    return delegate_.on_client_query_request(request);
}

std::optional<raft::JoinClusterResponse> PersistentRpcHandler::on_join_cluster_request(const raft::JoinClusterRequest& request) {
    auto response = delegate_.on_join_cluster_request(request);
    persist();
    return response;
}

std::optional<raft::JoinClusterStatusResponse> PersistentRpcHandler::on_join_cluster_status_request(const raft::JoinClusterStatusRequest& request) {
    return delegate_.on_join_cluster_status_request(request);
}

std::optional<raft::ReconfigureClusterResponse> PersistentRpcHandler::on_reconfigure_cluster_request(const raft::ReconfigureClusterRequest& request) {
...
std::optional<raft::AppendEntriesResponse> PersistentRpcHandler::on_append_entries_request(const raft::AppendEntriesRequest& request) {
    auto response = delegate_.on_append_entries_request(request);
    persist();
    return response;
}

std::optional<raft::InstallSnapshotResponse> PersistentRpcHandler::on_install_snapshot_request(const raft::InstallSnapshotRequest& request) {
